     ...
     <div class="container">
       ...
       <div class="collapse navbar-collapse navbar-right" id="menu">
          <ul class="nav navbar-nav">
            <li class="<?= esOpcionMenuActiva('index') ? 'active' : ''; ?> lien"><a href="index.php"><i class="fa fa-home sr-icons"></i> Home</a></li>
            ...
            <li class="<?= esOpcionMenuActiva('partner') ? 'active' : ''; ?>"><a href="partner.php"><i class="fa fa-hand-o-right sr-icons"></i> Partner</a></li>
          </ul>
       </div>
     </div>
   </nav>
